...
public class ProcessProduct {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ProcessProduct.class);
    ...
    public void execute(List<User> users, FileContentDTO fileContentDTO) throws Exception {
        try {
            ...
            if (user != null) {
                ...
                if (order != null) {
                    Product product = new Product(fileContentDTO.getProductId(), fileContentDTO.getOrderValue());
